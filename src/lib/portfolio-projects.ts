...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    tagline: "A clinic site that answers patient questions before they pick up the phone.",
    ...
    outcomes: [
      { label: "Patient trust", value: "Professional first impression from search" },
      { label: "Fewer basic calls", value: "Hours, services & team visible instantly" },
      { label: "Mobile-ready", value: "Built for how Hyderabad patients browse" },
    ],
  },
  {
    ...
    outcomes: [
      ...
      { label: "Clarity", value: "Treatments explained without jargon overload" },
