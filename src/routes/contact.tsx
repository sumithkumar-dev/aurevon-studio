...
function ContactPage() {
  useMeta({
    ...
    description:
      "Tell us about your business and we'll put together a thoughtful proposal.",
  });
      ...
      <section className="pt-[5.5rem] md:pt-28 pb-6">
        <div className="container-aurevon max-w-4xl">
          ...
          <p className="mt-5 text-base md:text-lg text-muted-foreground max-w-2xl">
            Share a few details about your business. We'll get back within one
            working day with a thoughtful proposal - design direction, scope and
            timeline.
          </p>
        </div>
      </section>
              ...
              <form className="grid gap-5 md:grid-cols-2" onSubmit={onSubmit}>
                ...
                <Field label="Business Name">
                  <input
                    ...
                    required
                    className={inputCls}
                    placeholder="e.g. Brew Haven Café"
                  />
                </Field>
                ...
                <div className="md:col-span-2">
                  <Field label="Tell us about your project">
                    <textarea
                      ...
                      rows={5}
                      className={inputCls}
                      placeholder="Briefly describe your business and what you'd like the website to do."
                    />
                  </Field>
                </div>
                {error && (
          ...
          <aside className="space-y-4">
            <div className="surface-card p-6">
              ...
              <ol className="mt-3 space-y-3 text-sm text-muted-foreground">
                <li>
                  <span className="text-accent">01 ·</span> We reply within 1
                  working day.
                </li>
                <li>
                  <span className="text-accent">02 ·</span> Short call to
                  understand your business.
                </li>
                <li>
                  <span className="text-accent">03 ·</span> You receive a clear
                  written proposal.
                </li>
              </ol>
            </div>
