...
function PortfolioPage() {
  ...
  return (
    <>
      <section className="pt-24 md:pt-32 pb-4 md:pb-8">
        <div className="container-aurevon max-w-4xl">
          ...
          <h1 className="text-5xl md:text-6xl text-balance leading-[1.05]">
            What a professional website looks like for{" "}
            <em className="text-accent not-italic">your</em> kind of business.
          </h1>
          <p className="mt-5 md:mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
