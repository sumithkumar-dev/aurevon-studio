      ...
      <section className="pt-[5.5rem] md:pt-28 pb-6">
        <div className="container-aurevon max-w-4xl">
          ...
          <h1 className="mt-4 text-[2.35rem] min-[390px]:text-[2.6rem] md:text-6xl text-balance leading-[1.06] md:leading-[1.05]">
            Websites built around the way your business{" "}
            <em className="text-accent not-italic">actually</em> works.
          </h1>
          <p className="mt-5 text-base md:text-lg text-muted-foreground max-w-2xl">
            Every engagement is shaped around real outcomes - clearer
            information, easier contact, stronger first impressions.
          </p>
        </div>
      </section>
